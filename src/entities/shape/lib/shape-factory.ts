 ...
 * Shape Factory
 *
 * Provides factory functions for creating shape entities with consistent defaults.
 * This centralizes shape creation logic and ensures all shapes are created with valid properties.
 */
